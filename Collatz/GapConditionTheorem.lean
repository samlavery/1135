...
The composite case is no longer needed: `walk_constrained_balance_nonzero`
in TiltBalance.lean subsumes the entire norm-gun pathway for gcd(m,6)=1. -/
